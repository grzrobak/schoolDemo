...
class ParentRestControllerTest {
    ...
    void getSchoolSummary() throws Exception {
        String url = "http://localhost:" + port + "/parent/1/2024/1";
        String response = restTemplate.getForObject(url, String.class);

        String expectedResponse = readFromFile("/rest/parentSummaryExpectedResponse.json");
