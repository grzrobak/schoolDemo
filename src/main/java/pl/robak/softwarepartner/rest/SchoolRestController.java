...
public class SchoolRestController {
    ...
    public SchoolSummary getSchoolSummary(@PathVariable Long id, @PathVariable int year, @PathVariable int month) {
        return schoolSummaryService.createSchoolSummary(id,year, month);
    }
